...
public class LondonDaily : MonoBehaviour
{
    public string api;
    ...
    IEnumerator Update()
    {
        api = "https://api.darksky.net/forecast/3049bfd4cdad104ba6f8789e3a448aeb/51.5074,0.1278?units=auto";
        StartAPI();
        yield break;
    }
    ...
    private IEnumerator FetchWeatherDataFromApi()
    {
        ...
        else
        {
            ...
            windspeedDaily.text = "Windspeed is " + response["daily"]["data"][0]["windSpeed"] + " Km/h";
